        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 text-center text-md-left">
              <h2 className="small highlight">Right sidebar</h2>
            </div>
            <div className="col-md-4 text-center text-md-right">
              <ol className="breadcrumb greylinks">
                ...
                <li className="active">Right sidebar</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              <Slider {...settings}>
                {
                  rightSidebarImg.map(item => <div key={item.id} style={{ position: "relative" }}>
                    {item.image}
